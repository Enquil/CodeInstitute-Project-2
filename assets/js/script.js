...
let questionArr = [];
const topwindow = document.getElementById("top");
const middle = document.getElementById("middle");
const bottom = document.getElementById("middle");
...
function handleSubmit() {
    ...
    middle.innerHTML = `<div class="block"><button id="newgame" onclick="newGame()"> New Game </button></div> <button id="stats">statistics</button>`;
}
...
function newGame() {
    ...
    middle.innerHTML = `<div>
                            <button data-type="Geography" onclick="selectcategory)">Geography</button> 
                            <button data-type="Science" onclick="select(category)">Science</button> 
                            <button data-type="Sports" onclick="select(category)">Sports</button>
                        </div>`;
